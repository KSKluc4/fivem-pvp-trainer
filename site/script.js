  ...
  var STRINGS = {
    pt: {
      ...
      features: {
        ...
        converter: { title: 'Conversor de sensibilidade', desc: "Converta sua sensibilidade do GTA V pra KovaaK's e Aim Lab automaticamente — sem contas de cabeça." },
      ...
      faq: {
        ...
        a4: "Você informa a sensibilidade que já usa no GTA V e o DPI do seu mouse — o app converte matematicamente pra a mesma resposta de mouse (graus por contagem), tanto no treino 3D interno quanto nos valores equivalentes pra KovaaK's e Aim Lab.",
    ...
    en: {
      ...
      features: {
        ...
        converter: { title: 'Sensitivity converter', desc: "Convert your GTA V sensitivity to KovaaK's and Aim Lab automatically — no mental math." },
      ...
      faq: {
        ...
        a4: "You enter the sensitivity you already use in GTA V and your mouse DPI — the app mathematically converts it to the same mouse response (degrees per count), both for the built-in 3D trainer and for the equivalent KovaaK's / Aim Lab values.",

...
# Bilingual (PT above, EN below) — simplest reliable option since the
# backend doesn't track each user's UI language preference (that lives in
# frontend localStorage only, per the app's i18n setup).
_SUBJECT = 'Redefinição de senha / Password reset — FiveM PvP Trainer'
    ...
    <div style="background:#10101c;padding:40px 20px;font-family:'Segoe UI',system-ui,-apple-system,sans-serif;">
      <div style="max-width:480px;margin:0 auto;background:#16162a;border:1px solid #33334d;border-radius:12px;padding:32px;">
        ...
        <p style="color:#a0a0b8;font-size:14px;line-height:1.5;margin:0 0 20px;">
          {greeting} Recebemos um pedido para redefinir a senha da sua conta.
        ...
        <hr style="border:none;border-top:1px solid #33334d;margin:28px 0;">

        <h1 style="color:#e8e8f0;font-size:20px;margin:0 0 16px;">Reset password</h1>
        <p style="color:#a0a0b8;font-size:14px;line-height:1.5;margin:0 0 20px;">
          {hi} we received a request to reset your account password.
        ...
        <p style="color:#7a839a;font-size:12px;line-height:1.5;margin:24px 0 0;">
          Se você não pediu essa redefinição, ignore este email — sua senha continua a mesma.<br>
